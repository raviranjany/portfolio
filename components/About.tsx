...
//     <section
//       id="about"
//       className="relative overflow-hidden bg-[var(--background-secondary)] py-16 sm:py-16 lg:py-12">

//       {/* Background decoration */}
//       <div className="pointer-events-none absolute inset-0 overflow-hidden">
//         <div
//           className="absolute -left-40 top-20 h-72 w-72 rounded-full bg-[var(--glow-primary)] opacity-20 blur-[110px]"/>
...
//           <h2
//             className="text-3xl font-bold leading-tight tracking-tight text-[var(--text-primary)] sm:text-4xl lg:text-4xl">
...
const summaryParagraphs = [
  <>
    ...
    with nearly 3 years of professional experience building
  ...
  <>
    ...
    , working across both frontend and backend. I build
    interactive interfaces with React and Next.js, develop
    APIs and server-side functionality with Node.js and
    Express.js, and work with MongoDB and MySQL for
  ...
  <>
    ...
    , creating responsive user experiences, integrating
    reliable APIs, and solving real-world development
    problems with practical and scalable solutions.
  </>,
];
      ...
      >
        ...
        >
          ...
          <p
            ...
            "
          >
            A developer focused on building clean, scalable
            and user-focused web experiences across the
            full stack.
          </p>
        </motion.div>
